...
def reject_invalid_run_root(protocol: dict, output_root: str | Path) -> None:
    ...
    references = (
        ...
        if version in {PROTOCOL_V15, PROTOCOL_V16, PROTOCOL_V17, PROTOCOL_V18, PROTOCOL_V19}
...
def main() -> None:
    ...
    if protocol_version == PROTOCOL_V19 and active_bundle is None:
        try:
            active_bundle = validate_active_formal_bundle(
                repository_root=ROOT,
                index_path=args.active_protocol_index,
    ...
    elif protocol_version in {PROTOCOL_V17, PROTOCOL_V18}:
        raise FormalExecutionError(
            "formal Protocol v1.0-v1.8 is audit-only"
        )
    ...
    if protocol_version in {PROTOCOL_V15, PROTOCOL_V16, PROTOCOL_V17, PROTOCOL_V18, PROTOCOL_V19}:
    ...
    if protocol_version in {PROTOCOL_V14, PROTOCOL_V15, PROTOCOL_V16, PROTOCOL_V17, PROTOCOL_V18, PROTOCOL_V19}:
        ...
        if protocol_version in {PROTOCOL_V15, PROTOCOL_V16, PROTOCOL_V17, PROTOCOL_V18, PROTOCOL_V19} and environment_resolution.runtime_audit.get(
            "resolution_source"
    ...
    if protocol_version in {PROTOCOL_V16, PROTOCOL_V17, PROTOCOL_V18, PROTOCOL_V19}:
    ...
    if protocol_version != PROTOCOL_V19:
        raise FormalExecutionError(
            "formal Protocol v1.0-v1.8 is audit-only; new execution requires v1.9"
        )
