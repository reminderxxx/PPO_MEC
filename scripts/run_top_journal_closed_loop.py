...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--train_eval_window_plan_path", type=str, default="")
...
def train_sa_for_seed(
    *,
    ...
    if args.train_eval_window_plan_path:
        cmd.extend(["--eval_window_plan_path", args.train_eval_window_plan_path])
