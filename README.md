...
> 独立合同、原声明/hash 及证据指针见 [docs/project/fixed_commit_continuation_contract.md](docs/project/fixed_commit_continuation_contract.md)。执行器未实现、独立批准未签发，`execution_authorized=false`。
