...
V27 = ROOT / "configs/experiment/typed_model_cache_formal_protocol_v2_9_20260906/protocol_v2_9_manifest.json"
...
def test_protocol_v27_is_unique_active_and_v26_is_historical() -> None:
    ...
    assert protocol["typed_model_cache_formal_protocol_version"] == "2.9.0"
