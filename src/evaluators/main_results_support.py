...
def summary_to_row(summary: dict[str, Any]) -> dict[str, Any]:
    ...
    return {
        ...
        "fairness_manifest_status": run_info.get("fairness_manifest_status", "unavailable"),
        "fairness_manifest_id": run_info.get("fairness_manifest_id"),
        "fairness_manifest_hash": run_info.get("fairness_manifest_hash"),
        "fairness_semantic_protocol_hash": run_info.get("fairness_semantic_protocol_hash"),
