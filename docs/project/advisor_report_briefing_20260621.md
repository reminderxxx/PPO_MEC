...
> 状态提示：本讲稿和配套 PPT 固化的是 v7 截止 2026-06-18 的证据，已被 `top_journal_readiness_audit_20260621.md` 的 v8 结果更新。复用前必须重做结果页；当前 verdict 为 `Major revision`，不能把两套协议数值混写。
...
- 本 deck 使用的 v7 严格审计：`docs/project/top_journal_readiness_audit_20260618.md`；最新 v8 审计为 `docs/project/top_journal_readiness_audit_20260621.md`，更新后必须重做对应结果页，不能混用两套协议数值。
